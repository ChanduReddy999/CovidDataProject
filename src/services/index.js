    ...
    try {
        ...
        const finalResult = filteredData.map((key) => {
            const Result = {
                ...
                "positivecasesfromsamplesreported": key.positivecasesfromsamplesreported || 0,
                ...
                "totalindividualstested": key.totalindividualstested || 0,
                "totalpositivecases": key.totalpositivecases || 0,
